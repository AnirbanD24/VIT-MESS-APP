...
public class TodaysMenu{
    ...
    String[][] d =
            {{"MONDAY", "(Poha, Matki gravy and sev, Sweet corn, Peanut Butter)", "(Veg fried rice, Mix dal tadka, Veg Manchurian, Curd, Rice papad, Rasam)", "(Mirchi Pakoda, Green chutney)", "(Mix Veg, Urad dal, Dalma Sambar, Chilli chana, Water melon, Gajar halwa)"},
